...
plot_allelic_imbalance=function(clonet_dir="",sample_data="",output_dir="",gene_data="",jobs=1,threads=3){
    ...
    full_data$AI=ifelse(full_data$chr.x=="X",full_data$integerCN,full_data$AllelicImbalance<=0.2|is.na(full_data$AllelicImbalance),"-",paste0(full_data$cnA.int,"/",full_data$cnB.int))
