...
plot_evolutionary_distance=function(cn_call_data="",sample_data="",ref_bins="",output_dir="",threads=3){
    ...
    png(filename=paste0(output_dir,sep,unique(full_data$Patient_ID),".NJ_all_plasma.png"),units="in",width=12,height=10)
    ...
    png(filename=paste0(unique(output_dir,sep,full_data$Patient_ID),".NJ_all_tissue.png"),units="in",width=12,height=10)
