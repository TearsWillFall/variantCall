...
plot_allelic_imbalance=function(clonet_dir="",sample_data="",output_dir="",gene_data="",threads=3){
    ...
    log2_corr_mtx=t(log2_corr_per_gene_wider[,-1])
    names(log2_corr_mtx)=log2_corr_per_gene_wider[,1]
    log2_corr_mtx=log2_corr_mtx[complete.cases(log2_corr_mtx),]
    cor_matrix=cor(log2_corr_mtx,use = "complete.obs")
