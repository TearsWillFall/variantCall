...
plot_allelic_imbalance=function(clonet_dir="",sample_data="",output_dir="",gene_data="",threads=3){
    ...
    row.names(log2_corr_per_gene_wider)=log2_corr_per_gene_wider[,1]
    log2_corr_per_gene_wider=log2_corr_per_gene_wider[,-1]
    cor_matrix=cor(log2_corr_per_gene_wider,use = "complete.obs")
