...
plot_allelic_imbalance=function(clonet_dir="",sample_data="",output_dir="",gene_data="",threads=3){
    ...
    log2_corr_per_gene_wider =t(log2_corr_per_gene_wider)
    log2_corr_per_gene_wider=as.matrix(log2_corr_per_gene_wider[complete.cases(log2_corr_per_gene_wider),])
    cor_matrix=cor(t)
