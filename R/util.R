...
plot_allelic_imbalance=function(clonet_dir="",sample_data="",output_dir="",gene_data="",threads=3){
    ...
    png(filename=paste0(out_file_dir,"/",unique(full_data$Patient_ID),".log2_corrected_CLONET.png"),width=10,height=20,units="in",res=1200)
    p=ComplexHeatmap::Heatmap(as.matrix(log2_corr_mtx),na_col="black",column_labels=c_names,
