...
generate_CLONET_config=function(patient_id="PATIENT",clonet_dir="tools/CLONET",snp_dir="",segment_data="",
    ...
    path_to_CLONET_functions <-", paste0("'",clonet_dir,"/Functions/CLONET.BasicFunctions.R"),"
...
generate_CLONET_sample_info=function(snp_dir="",patient_id="",output_dir=""){
    ...
    write.table(sample_info,file=paste0(out_file_dir,"/",out_file),quote=FALSE,row.names=FALSE,col.names=FALSE)
}
